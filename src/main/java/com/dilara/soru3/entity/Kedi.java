...
public class Kedi extends Hayvan implements IAyakli { //Hayvandan miras aldı, IAyakli interfaceine implement etti.
    public String cins;
    ...
    public Kedi(String yasamAlani, int yas, boolean evcilMi, int yasamDongusu, boolean yasiyorMu, boolean acMi, int aclikSuresi, int hareketDurumu) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("Kedi{");
    ...
    @Override
    public void suIc() {
        System.out.println("Kedi su içti.");
    ...
    @Override
    public void kos() {
        System.out.println("Kedi koştu.");
    }

    @Override
    public void zipla() {
        System.out.println("Kedi zıpladı.");
    }
}
